...
show_ads: true
description: A forecast becomes useful when the metric, deadline, threshold and data source are clear before the result is known.
hero_summary: A forecast becomes useful when the metric, deadline, threshold and data source are clear before the result is known.
layout: default
permalink: /resolution-rules/
sidebar_expanded_urls:
- /improving-your-think/
- /calibration/
nav_short_title: Resolution Rules
title: How To Make A Forecast Actually Checkable
title_full: How To Make A Forecast Actually Checkable
display_title_short: Resolution Rules
display_title: Resolution Rules
heading_title: How To Make A Forecast Actually Checkable
page_heading_title: How To Make A Forecast Actually Checkable
source_count: 43
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What Forecasting Tournaments Teach About Better Judgment
header:
  og_image: /assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-1-social.jpg
---
...
Learning from [predictions]({{ 'predictions/' | relative_url }}) depends on comparing what you expected with what actually happened. That comparison breaks down when the forecast itself is unclear.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/S4Oa_CD5a0w" title="Workshop: Exploring the intricacies of prediction markets | David Chee | EAG London 23" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=S4Oa_CD5a0w" target="_blank" rel="noopener noreferrer">Workshop: Exploring the intricacies of prediction markets | David Chee | EAG London 23</a></p><p class="youtube-embed-meta">Channel: Effective Altruism</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=S4Oa_CD5a0w" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=S4Oa_CD5a0w">Open on YouTube</a></p></div></div></div>
...
Many [outcomes]({{ 'outcomes/' | relative_url }}) vary continuously rather than occurring as simple yes-or-no events. The threshold specifies where success begins.
...
Explicit [thresholds]({{ 'thresholds/' | relative_url }}) prevent disputes over borderline cases.
...
<img src="{{ "/assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-3-dark.svg" | relative_url }}" alt="Resolution Rules illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_confidence_calibrati_3ec11e_resolution_rules_4d6bea-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
Without predefined resolution rules, those [comparisons]({{ 'comparisons/' | relative_url }}) become unreliable because the target itself keeps moving. A forecast that cannot be resolved consistently cannot improve future judgement.
