...
show_ads: true
description: Good self-explanation moves beyond paraphrase by forcing you to connect steps with because, if, therefore and unless.
hero_summary: Good self-explanation moves beyond paraphrase by forcing you to connect steps with because, if, therefore and unless.
layout: default
...
title: The Prompts That Expose Shallow Understanding
title_full: The Prompts That Expose Shallow Understanding
display_title_short: Self Explain
display_title: Self Explain
heading_title: The Prompts That Expose Shallow Understanding
page_heading_title: The Prompts That Expose Shallow Understanding
source_count: 15
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can the Idea Survive a New Example?
header:
  og_image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724_self_explanation_mec_95a0aa-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724_self_explanation_mec_95a0aa-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724_self_explanation_mec_95a0aa-Illustration-1-social.jpg
---
...
Within the broader distinction between familiarity and genuine understanding, self-explanation is valuable because it turns hidden [uncertainty]({{ 'uncertainty/' | relative_url }}) into visible questions. The moment you struggle to connect one step to the next is often the moment you discover what you do not yet understand.
...
[Worked examples]({{ 'worked-examples/' | relative_url }}) are especially vulnerable to creating false confidence because every decision has already been made. The learner sees a complete solution and mistakes smooth reading for genuine understanding.

<span class="citation-chip-wrap"><a class="citation-chip" href="https://education.asu.edu/sites/g/files/litvpz656/files/lcl/self-explanation_effect.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: education.asu.edu">[Self-explanation changes the task.]</a><span class="citation-popover" role="note"><span class="citation-popover-source">education.asu.edu</span><span class="citation-popover-title">self explanation effect</span><span class="citation-popover-snippet">A Model of the Self-Explanation Effectby K VanLehn · 1992 · Cited by 588 — Thus, studying examples properly raises the learning rate on s...</span></span></span>
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/2SlbsnaSNNM" title="The Illusion of Understanding: Phil Fernbach at TEDxGoldenGatePark" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=2SlbsnaSNNM" target="_blank" rel="noopener noreferrer">The Illusion of Understanding: Phil Fernbach at TEDxGoldenGatePark</a></p><p class="youtube-embed-meta">Channel: TEDx Talks</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=2SlbsnaSNNM" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=2SlbsnaSNNM">Open on YouTube</a></p></div></div></div>
...
* **Explaining [outcomes]({{ 'outcomes/' | relative_url }}) instead of processes.** Knowing what happened is different from knowing why.
...
1. Close the source.
2. Explain the idea aloud or in writing using your own words.
3. Insert "because" after every major claim.
4. Identify one assumption beginning with "this only works if...".
5. Describe one situation beginning with "this would fail when...".
6. Predict what should happen next before checking the answer.
7. Compare your explanation with the original and identify the first missing mechanism rather than every missing detail.
