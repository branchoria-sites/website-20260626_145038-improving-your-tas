...
show_ads: true
description: Good rules of thumb can simplify decisions when they are built around the few cues that usually matter.
hero_summary: Good rules of thumb can simplify decisions when they are built around the few cues that usually matter.
layout: default
permalink: /simple-rules/
sidebar_expanded_urls:
- /improving-your-think/
- /gut-vs-analysis/
nav_short_title: Simple Rules
title: Can simple rules beat careful calculation?
title_full: Can simple rules beat careful calculation?
display_title_short: Simple Rules
display_title: Simple Rules
heading_title: Can simple rules beat careful calculation?
page_heading_title: Can simple rules beat careful calculation?
source_count: 39
infographic_count: 3
planned_sections:
- What makes a rule of thumb fit its environment
- Spending, sleep and conversation rules that reduce regret
- When simple rules become too rigid
...
next_link:
  ...
  heading_title: When should you trust your gut?
header:
  og_image: /assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-1-social.jpg
---
...
Within the broader question of intuition versus analysis, simple rules occupy a middle ground. Instead of relying on momentary impulses or attempting exhaustive optimisation every time, they provide stable decision policies that reduce unnecessary deliberation while leaving room to slow down when the stakes are unusually high.
...
* **They rely on highly predictive cues.** A rule should ignore details that rarely change the outcome and attend to the few signals that usually do.
* **They are easy to remember and apply.** If a rule requires pages of exceptions, it no longer reduces cognitive effort.
* **They have been calibrated through feedback.** Good rules evolve after repeated experience, correction and refinement rather than remaining fixed forever.
...
Many everyday decisions are repeated hundreds of times. Creating a policy in advance often produces better [outcomes]({{ 'outcomes/' | relative_url }}) than making each choice from scratch.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/Oo7sWUtApr4" title="Homo Heuristicus: Rationality for Mortals" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=Oo7sWUtApr4" target="_blank" rel="noopener noreferrer">Homo Heuristicus: Rationality for Mortals</a></p><p class="youtube-embed-meta">Channel: University of California Television (UCTV)</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=Oo7sWUtApr4" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=Oo7sWUtApr4">Open on YouTube</a></p></div></div></div>

### Spending

Financial decisions are especially vulnerable to emotion, marketing and fatigue. Instead of evaluating every purchase independently, people often benefit from rules that remove unnecessary debate.
...
* Waiting 24 hours before making non-essential purchases above a chosen amount.
* Automatically saving a fixed percentage of income before discretionary spending.
* Comparing purchases by hours of work rather than by price alone.
* Requiring one meaningful reason to buy rather than many weak justifications.

</div>

These rules do not guarantee perfect financial decisions, but they reduce impulsive spending by shifting effort from repeated momentary temptation to a single deliberate policy.

### Sleep

Sleep often suffers because nightly decisions are made when self-control is already depleted. A simple routine can outperform repeated attempts to negotiate with oneself.
...
* Maintaining a consistent bedtime on most days.
* Avoiding work-related decisions after a predetermined evening cut-off.
* Treating insufficient sleep as a reason to postpone major commitments where practical.

</div>

Here the rule removes the need for nightly bargaining. The decision has already been made.


<img src="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-2-dark.svg" | relative_url }}" alt="Simple Rules illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Conversations
...
* Pause briefly before replying when emotionally activated.
* Ask one clarifying question before disagreeing.
* Avoid sending important emails or messages while angry.
* Criticise behaviour rather than personal character.

</div>

These policies do not eliminate conflict. Instead, they reduce preventable errors created by haste and emotional escalation.

Across all three domains, the underlying mechanism is similar: the rule limits the number of decisions requiring fresh analysis, preserving attention for situations that genuinely differ from the norm.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/niSdtsqyF7s" title="Creating fast-and-frugal decision trees with FFTrees" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=niSdtsqyF7s" target="_blank" rel="noopener noreferrer">Creating fast-and-frugal decision trees with FFTrees</a></p><p class="youtube-embed-meta">Channel: Nathaniel Phillips</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=niSdtsqyF7s" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=niSdtsqyF7s">Open on YouTube</a></p></div></div></div>
...
This is one reason experienced professionals often rely on [checklists]({{ 'checklists/' | relative_url }}), standard operating procedures and predefined [thresholds]({{ 'thresholds/' | relative_url }}). Such tools do not replace expertise; they preserve it by preventing routine mistakes.


<div class="youtube-embed-container youtube-embed-fallback youtube-embed-link-only"><div class="youtube-embed-card"><div class="youtube-embed-link-panel"><span class="youtube-embed-link-kicker">YouTube</span><a href="https://www.youtube.com/watch?v=YUqg4ZaqS4c" target="_blank" rel="noopener noreferrer">Homo Heuristicus: Decision Making in an Uncertain World | Gerd Gigerenzer</a></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=YUqg4ZaqS4c" target="_blank" rel="noopener noreferrer">Homo Heuristicus: Decision Making in an Uncertain World | Gerd Gigerenzer</a></p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=YUqg4ZaqS4c" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=YUqg4ZaqS4c">Open on YouTube</a></p></div></div></div>

## When simple rules become too rigid

A good rule should simplify recurring decisions without becoming an unquestioned law. Every shortcut has conditions under which it ceases to fit the environment.
...
* **Ignoring obvious exceptions.** A rule should not override strong new evidence.
* **Applying one rule everywhere.** A strategy that works for grocery shopping may be unsuitable for choosing a career.
* **Confusing convenience with accuracy.** Easy decisions are not automatically good decisions.
* **Continuing after circumstances change.** Rules created for one stage of life may become outdated.
...
* Is this rule still reducing mistakes?
* Have the conditions changed?
* Do repeated exceptions suggest the rule needs revising?

</div>

Treating rules as hypotheses rather than permanent truths keeps them useful without becoming dogmatic.


<img src="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-3-dark.svg" | relative_url }}" alt="Simple Rules illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_intuition_vs_analysi_f4ec00_fast_frugal_rules_abc8bb-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Can simple rules beat careful calculation?
