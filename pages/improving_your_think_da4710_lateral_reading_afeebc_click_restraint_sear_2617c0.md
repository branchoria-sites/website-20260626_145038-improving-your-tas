...
show_ads: true
description: Better lateral reading starts by scanning search results carefully instead of clicking the first familiar or agreeable link.
hero_summary: Better lateral reading starts by scanning search results carefully instead of clicking the first familiar or agreeable link.
layout: default
permalink: /click-restraint/
sidebar_expanded_urls:
- /improving-your-think/
- /lateral-reading/
nav_short_title: Click Restraint
title: Why the first search result is not enough
title_full: Why the first search result is not enough
display_title_short: Click Restraint
display_title: Click Restraint
heading_title: Why the first search result is not enough
page_heading_title: Why the first search result is not enough
source_count: 16
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why polished websites can fool careful readers
header:
  og_image: /assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/gbPEiCGxVVY" title="How to Find Better Information Online: Click Restraint" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=gbPEiCGxVVY" target="_blank" rel="noopener noreferrer">How to Find Better Information Online: Click Restraint</a></p><p class="youtube-embed-meta">Channel: Digital Inquiry Group</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=gbPEiCGxVVY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=gbPEiCGxVVY">Open on YouTube</a></p></div></div></div>
...
Without click restraint, you might immediately enter the advocacy site's [framing]({{ 'framing/' | relative_url }}) and spend several minutes reading it before discovering its perspective.
...
<img src="{{ "/assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-3-dark.svg" | relative_url }}" alt="Click Restraint illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_lateral_reading_afeebc_click_restraint_sear_2617c0-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
