...
show_ads: true
description: Randomisation helps separate treatment effects from pre-existing differences, but it still needs bias checks and careful interpretation.
hero_summary: Randomisation helps separate treatment effects from pre-existing differences, but it still needs bias checks and careful interpretation.
layout: default
permalink: /randomisation/
sidebar_expanded_urls:
- /improving-your-think/
- /cause-check/
nav_short_title: Randomisation
title: Why Random Assignment Changes the Question
title_full: Why Random Assignment Changes the Question
display_title_short: Randomisation
display_title: Randomisation
heading_title: Why Random Assignment Changes the Question
page_heading_title: Why Random Assignment Changes the Question
source_count: 25
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When the Headline Average Gets It Wrong
header:
  og_image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/4SLhLs664zQ" title="Randomized Controlled Trials: Causal Inference Bootcamp" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=4SLhLs664zQ" target="_blank" rel="noopener noreferrer">Randomized Controlled Trials: Causal Inference Bootcamp</a></p><p class="youtube-embed-meta">Channel: Mod•U: Powerful Concepts in Social Science</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=4SLhLs664zQ" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=4SLhLs664zQ">Open on YouTube</a></p></div></div></div>

## Why random assignment is different from simply comparing groups

Many observational [comparisons]({{ 'comparisons/' | relative_url }}) appear convincing because one group performs better than another. The difficulty is knowing whether the intervention caused the difference or whether the groups were already different in important ways.
...
These habits help avoid confusing correlation with [causation]({{ 'causation/' | relative_url }}) outside formal experiments.


<img src="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-3-dark.svg" | relative_url }}" alt="Randomisation illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_randomised_trials_cbfee3-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The central insight
