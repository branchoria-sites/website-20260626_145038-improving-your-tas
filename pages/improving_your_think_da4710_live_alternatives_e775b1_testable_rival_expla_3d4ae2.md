...
show_ads: true
description: A useful alternative names a mechanism, predicts different evidence, and changes what you would check next.
hero_summary: A useful alternative names a mechanism, predicts different evidence, and changes what you would check next.
layout: default
permalink: /testable-rivals/
sidebar_expanded_urls:
- /improving-your-think/
- /alternatives/
nav_short_title: Testable Rivals
title: Make Alternatives Specific Enough To Matter
title_full: Make Alternatives Specific Enough To Matter
display_title_short: Testable Rivals
display_title: Testable Rivals
heading_title: Make Alternatives Specific Enough To Matter
page_heading_title: Make Alternatives Specific Enough To Matter
source_count: 16
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Is It Motivation Or Something Else?
header:
  og_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-1-social.jpg
---
...
[Mechanisms]({{ 'mechanisms/' | relative_url }}) prevent explanations from becoming empty descriptions disguised as causes.
...
<img src="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-2-dark.svg" | relative_url }}" alt="Testable Rivals illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_testable_rival_expla_3d4ae2-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
Good [rivals]({{ 'rivals/' | relative_url }}) predict:

* different records
* different witnesses
* different timing
* different measurements
* different future [outcomes]({{ 'outcomes/' | relative_url }})
