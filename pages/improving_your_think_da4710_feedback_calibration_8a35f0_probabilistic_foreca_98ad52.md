...
show_ads: true
description: Putting a number on uncertainty turns vague judgement into feedback that can be checked across many predictions.
hero_summary: Putting a number on uncertainty turns vague judgement into feedback that can be checked across many predictions.
layout: default
permalink: /forecast-scores/
sidebar_expanded_urls:
- /improving-your-think/
- /feedback/
nav_short_title: Forecast Scores
title: Why Saying 70 Percent Changes Feedback
title_full: Why Saying 70 Percent Changes Feedback
display_title_short: Forecast Scores
display_title: Forecast Scores
heading_title: Why Saying 70 Percent Changes Feedback
page_heading_title: Why Saying 70 Percent Changes Feedback
source_count: 16
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What Forecasting Tournaments Teach Daily Decisions
header:
  og_image: /assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-1-social.jpg
---
...
Calibration refers to the agreement between stated confidence and observed [outcomes]({{ 'outcomes/' | relative_url }}). It is not judged from one prediction but from many.
...
Large forecasting [tournaments]({{ 'tournaments/' | relative_url }}) provide unusually strong evidence because participants make hundreds of probability forecasts before outcomes are known.

The most influential example is the [Good Judgment]({{ 'good-judgment/' | relative_url }}) Project, which studied thousands of forecasters making geopolitical predictions over several years. Rather than evaluating isolated predictions, researchers tracked probability estimates using scoring rules such as the Brier score.
...
1. **Record probabilities before the outcome.** Write "65%" or "80%", not simply "likely".
2. **Choose questions with clear resolution criteria.** Ambiguous outcomes weaken feedback.
3. **Accumulate enough predictions.** Twenty forecasts reveal little; one hundred begin to show meaningful patterns.
4. **Group forecasts into confidence ranges.** For example, compare all predictions between 60–69%, 70–79% and 80–89%.
5. **Compare expected and observed frequencies.** If predictions in the 80–89% range succeed only about 60% of the time, confidence is too high.
6. **Adjust future confidence rather than merely celebrating correct answers.**
...
<img src="{{ "/assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-3-dark.svg" | relative_url }}" alt="Forecast Scores illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_feedback_calibration_8a35f0_probabilistic_foreca_98ad52-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
