...
show_ads: true
description: A hidden third factor can make a cause look powerful even when it is only travelling with the real driver.
hero_summary: A hidden third factor can make a cause look powerful even when it is only travelling with the real driver.
layout: default
permalink: /confounders/
sidebar_expanded_urls:
- /improving-your-think/
- /cause-check/
nav_short_title: Confounders
title: The Hidden Factor Behind the Pattern
title_full: The Hidden Factor Behind the Pattern
display_title_short: Confounders
display_title: Confounders
heading_title: The Hidden Factor Behind the Pattern
page_heading_title: The Hidden Factor Behind the Pattern
source_count: 23
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why the Chart Can Beat the Average
header:
  og_image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-1-social.jpg
---
...
Understanding confounders is an essential thinking skill because many persuasive stories are built on visible patterns rather than [fair comparisons]({{ 'fair-compare/' | relative_url }}). The critical question is not simply whether two things move together, but whether something else could be producing both.
...
* Wealthier neighbourhoods may have more parks and better health [outcomes]({{ 'outcomes/' | relative_url }}). Income, education and healthcare access may partly explain both.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/tL86VPitfC4" title="Confounding Variables in Research: What They Are &amp; How to Control Them" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=tL86VPitfC4" target="_blank" rel="noopener noreferrer">Confounding Variables in Research: What They Are &amp; How to Control Them</a></p><p class="youtube-embed-meta">Channel: The Research Vault</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=tL86VPitfC4" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=tL86VPitfC4">Open on YouTube</a></p></div></div></div>
...
Not every misleading causal story is caused by confounding alone. Two related [mechanisms]({{ 'mechanisms/' | relative_url }}) frequently reinforce the illusion.


<img src="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-2-dark.svg" | relative_url }}" alt="Confounders illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_cause_correlation_008ee5_confounders_hidden_d_239664-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Reverse causation
