...
show_ads: true
description: Forgetting is useful when a spaced session reveals which definition, step or assumption has not survived.
hero_summary: Forgetting is useful when a spaced session reveals which definition, step or assumption has not survived.
layout: default
permalink: /weak-links/
sidebar_expanded_urls:
- /improving-your-think/
- /spacing/
nav_short_title: Weak links
title: Let forgetting show what needs repair
title_full: Let forgetting show what needs repair
display_title_short: Weak links
display_title: Weak links
heading_title: Let forgetting show what needs repair
page_heading_title: Let forgetting show what needs repair
source_count: 66
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Can one concept travel across situations?
header:
  og_image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_forgetting_weak_link_ba522e-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_forgetting_weak_link_ba522e-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_forgetting_weak_link_ba522e-Illustration-1-social.jpg
---

## Introduction

Forgetting can be useful when it exposes the part of an idea that has not survived the gap between study sessions. In [distributed practice]({{ 'spacing/' | relative_url }}), the point is not to wait until everything has vanished, but to return after enough time has passed that definitions, steps and assumptions must be rebuilt from memory. The [weak link]({{ 'weak-link/' | relative_url }}) is often not the whole topic. It may be one missing condition in a definition, one skipped step in a procedure, or one assumption that felt obvious during study but disappears when the learner has to reason independently.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/gtmMMR7SJKw" title="robert bjork - desirable difficulties: slowing down learning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=gtmMMR7SJKw" target="_blank" rel="noopener noreferrer">robert bjork - desirable difficulties: slowing down learning</a></p><p class="youtube-embed-meta">Channel: gocognitive</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=gtmMMR7SJKw" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=gtmMMR7SJKw">Open on YouTube</a></p></div></div></div>
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/1FQoGUCgb5w" title="robert bjork - storage strength vs. retrieval strength" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=1FQoGUCgb5w" target="_blank" rel="noopener noreferrer">robert bjork - storage strength vs. retrieval strength</a></p><p class="youtube-embed-meta">Channel: gocognitive</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=1FQoGUCgb5w" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=1FQoGUCgb5w">Open on YouTube</a></p></div></div></div>
...
1. **[Retrieve first]({{ 'retrieve-first/' | relative_url }}):** write or say the explanation from memory.

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

2. **Mark the break:** identify the first definition, step or assumption that failed.
3. **Check the source:** compare the attempt with the original explanation or worked solution.
4. **Repair the link:** restate the missing part in plain language and connect it to the next step.
5. **Retest later:** return after another delay with a new prompt or example.
