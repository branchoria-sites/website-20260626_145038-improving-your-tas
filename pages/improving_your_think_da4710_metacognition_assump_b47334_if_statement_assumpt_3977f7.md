...
show_ads: true
description: Turning a confident claim into an if-statement makes the conditions behind it visible enough to inspect.
hero_summary: Turning a confident claim into an if-statement makes the conditions behind it visible enough to inspect.
layout: default
permalink: /if-tests/
sidebar_expanded_urls:
- /improving-your-think/
- /metacognition/
nav_short_title: If Tests
title: What Must Be True First?
title_full: What Must Be True First?
display_title_short: If Tests
display_title: If Tests
heading_title: What Must Be True First?
page_heading_title: What Must Be True First?
source_count: 36
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: What If Your First Read Is Wrong?
header:
  og_image: /assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-1-social.jpg
---
...
Hidden condition: *If the source has relevant expertise, accurate evidence, and fair reporting, then I should trust it.*
* "I understand this chapter."
Hidden condition: *If I can explain the ideas without looking and solve unfamiliar problems, then I understand it.*
* "The project is behind schedule because the team lacks motivation."
Hidden condition: *If motivation is the main limiting factor rather than unclear priorities, missing resources, or unrealistic deadlines, then that explanation fits.*
...
Not every assumption matters equally. Some are merely background details; others are **[load-bearing]({{ 'load-bearing/' | relative_url }}) assumptions**. If they fail, the entire conclusion collapses.
...
Notice that only one important condition has been isolated. This avoids trying to validate every possible [uncertainty]({{ 'uncertainty/' | relative_url }}) before acting.


<img src="{{ "/assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-2-dark.svg" | relative_url }}" alt="If Tests illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_metacognition_assump_b47334_if_statement_assumpt_3977f7-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Evaluating sources
...
Initial conclusionWeakest visible conditionUseful test"This marketing campaign will succeed."The target audience values the proposed message.Conduct customer interviews or a small campaign trial."This article is trustworthy."The central claims accurately represent the evidence.Check the original studies or independent reporting."I am ready for the exam."I can retrieve knowledge without [prompts]({{ 'prompts/' | relative_url }}). Complete a timed practice test from memory."The meeting solved the problem."Participants actually agreed on the next actions.Ask each participant to describe the agreed plan independently.
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Provides practical techniques for evaluating claims, identifying premises, and checking whether conclusions logically follow.</p>
        <div class="fr-book-actions">
