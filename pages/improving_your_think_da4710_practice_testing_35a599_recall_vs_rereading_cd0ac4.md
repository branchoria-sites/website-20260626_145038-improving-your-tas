...
show_ads: true
description: The harder feeling of self-testing often signals the useful work that rereading can hide.
hero_summary: The harder feeling of self-testing often signals the useful work that rereading can hide.
layout: default
permalink: /recall-vs-reread/
sidebar_expanded_urls:
- /improving-your-think/
- /practice-tests/
nav_short_title: Recall vs Reread
title: Why Rereading Feels Better but Teaches Less
title_full: Why Rereading Feels Better but Teaches Less
display_title_short: Recall vs Reread
display_title: Recall vs Reread
heading_title: Why Rereading Feels Better but Teaches Less
page_heading_title: Why Rereading Feels Better but Teaches Less
source_count: 23
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How to Build a Self Test That Actually Works
header:
  og_image: /assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-1-social.jpg
---
...
<img src="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-2-dark.svg" | relative_url }}" alt="Recall vs Reread illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to tell whether you can use an idea
...
For example, recognising the definition of "base rate neglect" while rereading is different from spontaneously asking, during a discussion of medical screening or financial forecasting, whether [base rates]({{ 'base-rates/' | relative_url }}) have been ignored. The second situation demonstrates usable understanding because the concept has become available when it is actually needed.
...
1. Read to understand the material.
2. Close the source and retrieve what you remember.
3. Compare your answer with the original.
4. Fill the gaps.
5. Repeat retrieval after some delay.
...
<img src="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-3-dark.svg" | relative_url }}" alt="Recall vs Reread illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_practice_testing_35a599_recall_vs_rereading_cd0ac4-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The key insight
