...
show_ads: true
description: Being correct for the wrong reason can hide a weak mental model unless the prediction includes the reasoning behind it.
hero_summary: Being correct for the wrong reason can hide a weak mental model unless the prediction includes the reasoning behind it.
layout: default
permalink: /wrong-reason/
sidebar_expanded_urls:
- /improving-your-think/
- /predictions/
nav_short_title: Wrong Reason
title: When being right still teaches the wrong lesson
title_full: When being right still teaches the wrong lesson
display_title_short: Wrong Reason
display_title: Wrong Reason
heading_title: When being right still teaches the wrong lesson
page_heading_title: When being right still teaches the wrong lesson
source_count: 30
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: Why solutions look easier after you see them
header:
  og_image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/tuFG8m7fbvw" title="Outcome Bias: Why You Should Ignore Results" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=tuFG8m7fbvw" target="_blank" rel="noopener noreferrer">Outcome Bias: Why You Should Ignore Results</a></p><p class="youtube-embed-meta">Channel: Learn Fast</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=tuFG8m7fbvw" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=tuFG8m7fbvw">Open on YouTube</a></p></div></div></div>
...
1. **Compare your explanation with the actual causal story.** Ask which parts of your reasoning genuinely matched the evidence and which merely happened to point in the right direction.
2. **Identify the decisive assumption.** Which belief, if changed, would have changed your prediction? Focus on that rather than every minor detail.
3. **Replace vague explanations with specific mechanisms.** "It seemed likely" is difficult to evaluate later. "I expected demand to increase because prices fell" creates a testable claim.
4. **Test the explanation on a different example.** If the reasoning only works for one isolated case, it may have been fitted to the outcome rather than reflecting a general principle.
...
<img src="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-3-dark.svg" | relative_url }}" alt="Wrong Reason illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5_right_answer_wrong_r_913adc-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/D5-Vt_-MZkk" title="Outcome Bias: Why Smart Decisions Still Fail | Psychology of Decision-Making for Leaders" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=D5-Vt_-MZkk" target="_blank" rel="noopener noreferrer">Outcome Bias: Why Smart Decisions Still Fail | Psychology of Decision-Making for Leaders</a></p><p class="youtube-embed-meta">Channel: Leadership Notes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=D5-Vt_-MZkk" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=D5-Vt_-MZkk">Open on YouTube</a></p></div></div></div>
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Encourages examining reasoning processes instead of passive acceptance.</p>
        <div class="fr-book-actions">
