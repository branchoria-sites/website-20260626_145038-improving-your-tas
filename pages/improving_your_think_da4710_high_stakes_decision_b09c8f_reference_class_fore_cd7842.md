...
title: What happened when others tried this?
title_full: What happened when others tried this?
display_title_short: Base Rates
display_title: Base Rates
heading_title: What happened when others tried this?
page_heading_title: What happened when others tried this?
source_count: 25
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why experts still need checklists
header:
  og_image: /assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-1-social.jpg
---
...
* How variable were the [outcomes]({{ 'outcomes/' | relative_url }})?
...
<img src="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-2-dark.svg" | relative_url }}" alt="Base Rates illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">

<div class="content-enhancement content-enhancement--step-flow" markdown="1">

1. Produce the normal project estimate.
2. Identify an appropriate comparison class.
3. Examine the actual distribution of past outcomes.
4. Position the current case within that distribution.
5. Adjust only when there is strong evidence that the current case differs materially from previous ones.
...
* **Using outdated [comparisons]({{ 'comparisons/' | relative_url }}).** Changes in technology, regulation or markets may require updating the comparison group.
...
* projects involve substantial [uncertainty]({{ 'uncertainty/' | relative_url }});
...
<img src="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-3-dark.svg" | relative_url }}" alt="Base Rates illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_high_stakes_decision_b09c8f_reference_class_fore_cd7842-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
