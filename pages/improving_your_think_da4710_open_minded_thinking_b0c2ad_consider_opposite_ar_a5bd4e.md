...
show_ads: true
description: Deliberately asking what would be visible if you were wrong can reduce biased judgement more than simply trying to be fair.
hero_summary: Deliberately asking what would be visible if you were wrong can reduce biased judgement more than simply trying to be fair.
layout: default
...
title: The Question That Interrupts Defensive Reasoning
title_full: The Question That Interrupts Defensive Reasoning
...
page_heading_title: The Question That Interrupts Defensive Reasoning
source_count: 35
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Listen First Without Surrendering Your Standards
header:
  og_image: /assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-1-social.jpg
---
...
* **Which fact would [surprise]({{ 'surprise/' | relative_url }}) me if the other person were actually correct?**
...
1. State your current conclusion as clearly as possible.
2. Imagine, briefly, that it is false.
3. Generate the strongest realistic alternative explanation.
4. Ask what evidence would distinguish the two accounts.
5. Return to your original position only after evaluating both by the [same standards]({{ 'same-standard/' | relative_url }}).
...
<img src="{{ "/assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-3-dark.svg" | relative_url }}" alt="Opposite Test illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_open_minded_thinking_b0c2ad_consider_opposite_ar_a5bd4e-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
