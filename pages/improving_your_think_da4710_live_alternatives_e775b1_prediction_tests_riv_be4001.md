...
show_ads: true
description: The best evidence check asks what one explanation would make likely and a rival would make surprising.
hero_summary: The best evidence check asks what one explanation would make likely and a rival would make surprising.
layout: default
permalink: /prediction-tests/
sidebar_expanded_urls:
- /improving-your-think/
- /alternatives/
nav_short_title: Prediction Tests
title: The Test That Breaks A Tie
title_full: The Test That Breaks A Tie
display_title_short: Prediction Tests
display_title: Prediction Tests
heading_title: The Test That Breaks A Tie
page_heading_title: The Test That Breaks A Tie
source_count: 38
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When Evidence Fits Too Many Stories
header:
  og_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-1-social.jpg
---

## Introduction

When two explanations both fit the facts you already know, asking whether the evidence is *consistent* with your favourite explanation is not enough. The more useful question is: **what would each explanation predict that the other would find surprising?** A prediction test is designed to answer exactly that question. Instead of collecting more evidence at random, you identify observations that would strongly favour one explanation over its [rivals]({{ 'rivals/' | relative_url }}).
...
<img src="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-3-dark.svg" | relative_url }}" alt="Prediction Tests illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_prediction_tests_riv_be4001-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **State the competing explanations clearly.** Each should describe a distinct mechanism rather than merely restating the outcome.
2. **List unique predictions.** Write down observations that each explanation specifically expects.
3. **Identify the most diagnostic test.** Choose evidence that would favour one explanation much more than another.
4. **Record predictions before collecting evidence.** This reduces hindsight and motivated reinterpretation.
5. **Update comparatively rather than absolutely.** Ask which explanation became stronger relative to its competitors rather than whether one explanation still seems possible.
