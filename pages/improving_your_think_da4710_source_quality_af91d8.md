...
- improving_your_think_da4710_source_quality_af91d8_index
...
show_ads: true
description: Reliable analysis separates whether a source is trustworthy from whether it says what you hoped to hear.
hero_summary: Reliable analysis separates whether a source is trustworthy from whether it says what you hoped to hear.
layout: default
permalink: /source-quality/
sidebar_expanded_urls:
- /improving-your-think/
nav_short_title: Source Quality
title: Trustworthy Source or Friendly Source?
title_full: Trustworthy Source or Friendly Source?
display_title_short: Source Quality
display_title: Source Quality
heading_title: Trustworthy Source or Friendly Source?
page_heading_title: Trustworthy Source or Friendly Source?
source_count: 107
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Spacing Practice Makes Thinking Stick
header:
  og_image: /assets/images/improving_your_think_da4710_source_quality_af91d8-overview-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_source_quality_af91d8-overview.webp
image: /assets/images/improving_your_think_da4710_source_quality_af91d8-overview-social.jpg
---
...
<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-overview.webp" | relative_url }}" alt="Overview image for Source Quality" loading="eager" decoding="sync" fetchpriority="high">
Better thinking does not mean distrusting everything. It means checking whether agreement is **independent, evidence-based and proportionate**. A cluster of [copied claims]({{ 'copied-claims/' | relative_url }}) is not the same as corroboration. A lone high-quality source may be more useful than ten friendly repeats. And when strong sources disagree, the right response is not cynicism, but slower analysis: inspect methods, incentives, expertise, [uncertainty]({{ 'uncertainty/' | relative_url }}) and what each source is actually claiming.
...
<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-2-dark.svg" | relative_url }}" alt="Source Quality illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
* **What decision has to be made now?** For [low-stakes]({{ 'low-stakes/' | relative_url }}) beliefs, waiting is reasonable. For high-stakes choices, act on the best available evidence while preserving room to revise.
...
<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-3-dark.svg" | relative_url }}" alt="Source Quality illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
