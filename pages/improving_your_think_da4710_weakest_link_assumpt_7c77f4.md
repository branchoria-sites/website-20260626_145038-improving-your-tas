...
- improving_your_think_da4710_weakest_link_assumpt_7c77f4_index
...
show_ads: true
description: A conclusion often depends on one fragile assumption that deserves more attention than the rest.
hero_summary: A conclusion often depends on one fragile assumption that deserves more attention than the rest.
layout: default
permalink: /weakest-link/
sidebar_expanded_urls:
- /improving-your-think/
nav_short_title: Weakest Link
title: Find the Assumption That Could Break Everything
title_full: Find the Assumption That Could Break Everything
display_title_short: Weakest Link
display_title: Weakest Link
heading_title: Find the Assumption That Could Break Everything
page_heading_title: Find the Assumption That Could Break Everything
source_count: 108
infographic_count: 3
planned_sections:
...
prev_link:
  ...
  heading_title: What Are You Giving Up?
header:
  og_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-overview-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-overview.webp
image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-overview-social.jpg
---

## Introduction

Weakest-link thinking is the habit of asking: “Which assumption, if wrong, would do the most damage to this conclusion?” It is useful because many weak arguments do not fail everywhere. They often rest on several reasonable points plus one fragile bridge: a forecast about demand, an untested causal claim, a hidden definition, a missing alternative, or a belief that everyone involved will behave as expected. In [critical thinking]({{ 'critical-skills/' | relative_url }}), the aim is not to attack every sentence equally. It is to find the [load-bearing]({{ 'load-bearing/' | relative_url }}) assumption and test that first.
...
<img src="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-1-dark.svg" | relative_url }}" alt="Weakest Link illustration 1" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How to locate the fragile assumption
...
<img src="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-3-dark.svg" | relative_url }}" alt="Weakest Link illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Weakest-link thinking versus ordinary risk lists
