...
show_ads: true
description: Evidence that fits your favorite story may be weak if the same fact would also fit serious rivals.
hero_summary: Evidence that fits your favorite story may be weak if the same fact would also fit serious rivals.
layout: default
permalink: /shared-evidence/
sidebar_expanded_urls:
- /improving-your-think/
- /alternatives/
nav_short_title: Shared Evidence
title: When Evidence Fits Too Many Stories
title_full: When Evidence Fits Too Many Stories
display_title_short: Shared Evidence
display_title: Shared Evidence
heading_title: When Evidence Fits Too Many Stories
page_heading_title: When Evidence Fits Too Many Stories
source_count: 15
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Make Alternatives Specific Enough To Matter
header:
  og_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-1-social.jpg
---

## Introduction

A fact is only strong evidence if it helps you choose between competing explanations. If the same observation would be expected under several plausible explanations, then it confirms very little on its own. This is one of the easiest mistakes to make in everyday reasoning: treating a fact that is merely *compatible* with your preferred story as though it *favours* that story over its [rivals]({{ 'rivals/' | relative_url }}). Better judgement depends on asking a different question. Instead of asking, "Does this fit my explanation?", ask, "Would I be any less surprised to see this fact if another serious explanation were true?" That shift turns evidence from a simple match into a genuine test.
...
The complaints become informative only when examined alongside evidence that distinguishes between these possibilities, such as defect rates, competitor [comparisons]({{ 'comparisons/' | relative_url }}) or customer interviews focused on specific causes.
...
<img src="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-3-dark.svg" | relative_url }}" alt="Shared Evidence illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1_shared_evidence_trap_4a9729-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/wo3xpigIjts" title="What Is Confirmation Bias? | Psychological Explanation &amp; Examples" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=wo3xpigIjts" target="_blank" rel="noopener noreferrer">What Is Confirmation Bias? | Psychological Explanation &amp; Examples</a></p><p class="youtube-embed-meta">Channel: MindfulThinks</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=wo3xpigIjts" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=wo3xpigIjts">Open on YouTube</a></p></div></div></div>
...
Evidence is not valuable simply because it fits a story. Its value depends on whether it helps choose between [competing stories]({{ 'competing-stories/' | relative_url }}).
