...
show_ads: true
description: The most important assumption is not the shakiest one, but the one whose failure would force a different choice.
hero_summary: The most important assumption is not the shakiest one, but the one whose failure would force a different choice.
layout: default
permalink: /load-bearing/
sidebar_expanded_urls:
- /improving-your-think/
- /weakest-link/
nav_short_title: Load Bearing
title: Which Assumption Would Actually Change the Decision?
title_full: Which Assumption Would Actually Change the Decision?
display_title_short: Load Bearing
display_title: Load Bearing
heading_title: Which Assumption Would Actually Change the Decision?
page_heading_title: Which Assumption Would Actually Change the Decision?
source_count: 31
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Imagining Failure Can Improve a Plan
header:
  og_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-1-social.jpg
---
...
* **[Uncertainty]({{ 'uncertainty/' | relative_url }}):** How plausible is it that the assumption could be wrong?
...
<span class="citation-chip-wrap"><a class="citation-chip" href="https://www.rand.org/content/dam/rand/pubs/monograph_reports/2005/MR114.pdf" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: rand.org">[&gt; &quot;Is this assumption reasonable?&quot;]</a><span class="citation-popover" role="note"><span class="citation-popover-source">rand.org</span><span class="citation-popover-snippet">RAND CorporationAssumption-Based PlanningThe challenges in this approach are to identify the critical assumptions underlying an organizat...</span></span></span>
...
1. List every assumption supporting the decision.
2. Ask whether the decision survives if each assumption fails.
3. Eliminate assumptions whose failure changes little.
4. Rank the remaining assumptions by:

</div>
how much the conclusion depends on them;
how uncertain they currently are;
how costly it would be if they proved false.
5. Investigate the highest-ranked assumptions first.
...
<img src="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-3-dark.svg" | relative_url }}" alt="Load Bearing illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_load_bearing_assumpt_b1e8d0-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/RaDVuhbwPFI" title="Clarity for the Boss - Assumption Based Planning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=RaDVuhbwPFI" target="_blank" rel="noopener noreferrer">Clarity for the Boss - Assumption Based Planning</a></p><p class="youtube-embed-meta">Channel: Sharon Gilmour-Glover</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=RaDVuhbwPFI" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=RaDVuhbwPFI">Open on YouTube</a></p></div></div></div>
