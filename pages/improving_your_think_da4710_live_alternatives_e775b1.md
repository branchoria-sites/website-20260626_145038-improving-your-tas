...
- improving_your_think_da4710_live_alternatives_e775b1_index
...
show_ads: true
description: Comparing plausible alternatives prevents a good-sounding explanation from winning by default.
hero_summary: Comparing plausible alternatives prevents a good-sounding explanation from winning by default.
layout: default
...
next_link:
  ...
  heading_title: Ask Better Questions Before Seeking Answers
header:
  og_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1-overview-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1-overview.webp
image: /assets/images/improving_your_think_da4710_live_alternatives_e775b1-overview-social.jpg
---
...
For example, suppose a website’s conversion rate has fallen. A single-explanation thinker may say, “The redesign made the page worse,” then search for evidence that users dislike the redesign. A live-alternatives thinker compares several [mechanisms]({{ 'mechanisms/' | relative_url }}):
...
1. **The absence test:** What should be present if my favourite explanation is true, and is it actually missing?
2. **The rival-fit test:** What evidence would my least-liked serious alternative predict?
3. **The timing test:** Does the sequence of events fit one explanation better than the others?
4. **The mechanism test:** Can the explanation actually produce the effect at the observed size or speed?
5. **The reversal test:** What would I expect to see if the causal arrow ran the other way?
...
<img src="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-2-dark.svg" | relative_url }}" alt="Alternatives illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **Name the observation.** What exactly needs explaining?
2. **State the favourite explanation.** What mechanism do you currently think is at work?
3. **Add two live alternatives.** What else could explain the same facts without being silly or evasive?
4. **List shared evidence.** Which facts fit all explanations and therefore should not be overweighted?
5. **Find [diagnostic evidence]({{ 'diagnostic-evidence/' | relative_url }}).** Which fact would be likely under one explanation and unlikely under another?
6. **Run one prediction test.** What can you check next that would actually move the comparison?
7. **Update, do not defend.** Change confidence according to how the evidence treats the alternatives.
...
<img src="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-3-dark.svg" | relative_url }}" alt="Alternatives illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_live_alternatives_e775b1-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## The core takeaway
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/zGgJYKEKCzI" title="What is Abductive Reasoning? (Easiest Explanation)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=zGgJYKEKCzI" target="_blank" rel="noopener noreferrer">What is Abductive Reasoning? (Easiest Explanation)</a></p><p class="youtube-embed-meta">Channel: Helpful Professor Explains!</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=zGgJYKEKCzI" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=zGgJYKEKCzI">Open on YouTube</a></p></div></div></div>
