...
show_ads: true
description: A source's credentials matter only when its expertise fits the specific claim being evaluated.
hero_summary: A source's credentials matter only when its expertise fits the specific claim being evaluated.
layout: default
permalink: /fit-expertise/
sidebar_expanded_urls:
- /improving-your-think/
- /source-quality/
nav_short_title: Fit Expertise
title: The Wrong Expert Can Still Sound Right
title_full: The Wrong Expert Can Still Sound Right
display_title_short: Fit Expertise
display_title: Fit Expertise
heading_title: The Wrong Expert Can Still Sound Right
page_heading_title: The Wrong Expert Can Still Sound Right
source_count: 12
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When Anonymous Sources Deserve Trust
header:
  og_image: /assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1-social.jpg
---

## Introduction

When assessing whether a source is trustworthy, one of the most important questions is not “Is this person an expert?” but “Are they an expert on *this specific claim*?” Expertise is highly specialised. A distinguished physicist is not automatically a reliable guide to nutrition, and a respected surgeon is not necessarily qualified to interpret economic policy. Good [critical thinking]({{ 'critical-skills/' | relative_url }}) therefore focuses on the **fit between the source's expertise and the claim being evaluated**, rather than on prestige, fame or impressive credentials alone.


<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1-dark.svg" | relative_url }}" alt="Fit Expertise illustration 1" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-1-light.svg" | relative_url }}" loading="eager" decoding="sync" fetchpriority="high">
...
<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-2-dark.svg" | relative_url }}" alt="Fit Expertise illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
These organisations typically combine expertise from multiple specialists, review available evidence, document [uncertainty]({{ 'uncertainty/' | relative_url }}) and update conclusions when new evidence appears. Their authority comes less from the prestige of one individual than from transparent methods and collective evaluation.

For example, when evaluating vaccine safety, the most relevant sources are generally organisations responsible for reviewing large bodies of clinical evidence rather than isolated opinions from individual doctors speaking outside established evidence reviews. This reflects the difference between expertise exercised through systematic [assessment]({{ 'assessment/' | relative_url }}) and personal opinion.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/1WddY_ppllM" title="Evaluating Sources: Understanding Authority" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=1WddY_ppllM" target="_blank" rel="noopener noreferrer">Evaluating Sources: Understanding Authority</a></p><p class="youtube-embed-meta">Channel: Words and Meanings Explained</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=1WddY_ppllM" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=1WddY_ppllM">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-3-dark.svg" | relative_url }}" alt="Fit Expertise illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_source_quality_af91d8_expertise_claim_fit_a7ce2a-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **What exactly is the claim?** Define it as precisely as possible.
2. **What kind of expertise would someone need to know this?** Think about the specific knowledge required rather than broad status.
3. **Does the source actually possess that expertise?** Look beyond titles to training, experience and professional work.
4. **Are they speaking within that expertise?** Experts are often strongest when discussing their own speciality.
5. **What evidence accompanies the claim?** Expertise supports credibility, but evidence ultimately carries the argument.
