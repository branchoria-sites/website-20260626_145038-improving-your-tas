...
- improving_your_think_da4710_prediction_habits_f0daf5_index
...
show_ads: true
description: Making predictions before seeing results turns passive reading into a feedback-rich thinking exercise.
hero_summary: Making predictions before seeing results turns passive reading into a feedback-rich thinking exercise.
layout: default
permalink: /predictions/
sidebar_expanded_urls:
- /improving-your-think/
nav_short_title: Predictions
title: Predict First, Check Second
title_full: Predict First, Check Second
display_title_short: Predictions
display_title: Predictions
heading_title: Predict First, Check Second
page_heading_title: Predict First, Check Second
source_count: 76
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: How to Break Down a Hard Problem
header:
  og_image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5-overview-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5-overview.webp
image: /assets/images/improving_your_think_da4710_prediction_habits_f0daf5-overview-social.jpg
---
...
1. **Expected answer:** what you think will happen or be true.
2. **Confidence:** how sure you are, even roughly.
3. **Reason:** the cue, rule, analogy or assumption driving the forecast.
...
* **Right for the [wrong reason]({{ 'wrong-reason/' | relative_url }}):** the answer matched, but your explanation needs repair.
* **Wrong but close:** refine the boundary condition.
* **Wrong in a surprising way:** slow down and identify the missed cue.

This is especially powerful when reading [worked examples]({{ 'worked-examples/' | relative_url }}). Looking at a solution too early can make a difficult step seem natural. Predicting the next step first forces you to retrieve a principle, choose a method and notice where your current understanding breaks.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/x0zFJ-T7RBM" title="AE Live 18.6 - Metacognition: Empowering Students to Monitor and Evaluate Their Learning" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=x0zFJ-T7RBM" target="_blank" rel="noopener noreferrer">AE Live 18.6 - Metacognition: Empowering Students to Monitor and Evaluate Their Learning</a></p><p class="youtube-embed-meta">Channel: American English</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=x0zFJ-T7RBM" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=x0zFJ-T7RBM">Open on YouTube</a></p></div></div></div>
...
1. **What exactly did I predict?** Keep the original wording visible. Do not quietly rewrite it after seeing the answer.
2. **What happened instead?** State the difference plainly.
3. **What should change in my future attention?** Identify one cue, rule or assumption to watch next time.
...
<img src="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-2-dark.svg" | relative_url }}" alt="Predictions illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
Calibration means that your stated confidence matches your actual accuracy. If you say you are 80% confident across many predictions, roughly eight out of ten should be right. Perfect calibration is not realistic in daily life, but better calibration is learnable because feedback gives you repeated chances to compare certainty with [outcomes]({{ 'outcomes/' | relative_url }}).
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/jlYoa5qVd90" title="Past meets present: Prediction error drives episodic memory updating" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=jlYoa5qVd90" target="_blank" rel="noopener noreferrer">Past meets present: Prediction error drives episodic memory updating</a></p><p class="youtube-embed-meta">Channel: Cognitive Neuroscience Compendium</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=jlYoa5qVd90" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=jlYoa5qVd90">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-3-dark.svg" | relative_url }}" alt="Predictions illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_prediction_habits_f0daf5-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
