...
show_ads: true
description: A conclusion is weaker when another explanation fits the same facts better than the story you started with.
hero_summary: A conclusion is weaker when another explanation fits the same facts better than the story you started with.
layout: default
permalink: /rivals/
sidebar_expanded_urls:
- /improving-your-think/
- /weakest-link/
nav_short_title: Rivals
title: What Else Could Explain the Same Evidence?
title_full: What Else Could Explain the Same Evidence?
display_title_short: Rivals
display_title: Rivals
heading_title: What Else Could Explain the Same Evidence?
page_heading_title: What Else Could Explain the Same Evidence?
source_count: 15
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When 'Will' Quietly Becomes the Weak Link
header:
  og_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-1-social.jpg
---
...
This distinction is central to [critical thinking]({{ 'critical-skills/' | relative_url }}):

* **Supporting evidence** shows that an explanation could be true.
* **[Diagnostic evidence]({{ 'diagnostic-evidence/' | relative_url }})** helps distinguish between competing explanations because it fits one much better than the others.
...
The goal is not to invent endless possibilities. It is to identify the strongest realistic competitors and compare them using the [same standards]({{ 'same-standard/' | relative_url }}).
...
1. **State the current explanation clearly.**
2. **List at least two plausible alternatives.**
3. **Ask what each explanation predicts if it is true.**
4. **Look for evidence that separates them rather than merely supports them all.**
5. **Reduce confidence when multiple explanations remain equally consistent with the available facts.**
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/zOaKf_1RgZE" title="First Conclusion Bias" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=zOaKf_1RgZE" target="_blank" rel="noopener noreferrer">First Conclusion Bias</a></p><p class="youtube-embed-meta">Channel: Mental Models Daily</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=zOaKf_1RgZE" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=zOaKf_1RgZE">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-3-dark.svg" | relative_url }}" alt="Rivals illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_weakest_link_assumpt_7c77f4_rival_explanations_8b35a7-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
