...
- improving_your_think_da4710_familiarity_trap_82f724_index
...
show_ads: true
description: Rereading can feel fluent while leaving gaps that only explanation, prediction, or recall will reveal.
hero_summary: Rereading can feel fluent while leaving gaps that only explanation, prediction, or recall will reveal.
layout: default
permalink: /fluency-trap/
sidebar_expanded_urls:
- /improving-your-think/
nav_short_title: Fluency Trap
title: When Familiarity Feels Like Understanding
title_full: When Familiarity Feels Like Understanding
display_title_short: Fluency Trap
display_title: Fluency Trap
heading_title: When Familiarity Feels Like Understanding
page_heading_title: When Familiarity Feels Like Understanding
source_count: 120
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Is the Question Already Trapping You?
header:
  og_image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724-overview-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724-overview.webp
image: /assets/images/improving_your_think_da4710_familiarity_trap_82f724-overview-social.jpg
---
...
* **[Transfer]({{ 'transfer/' | relative_url }}):** “I can apply it in a different-looking case.”

The fluency trap hides between the first and the last four. A person may recognise “correlation is not [causation]({{ 'causation/' | relative_url }})” but still fail to identify a confounder in a real argument. They may recognise a statistical term but not know when it applies. They may follow a worked solution but freeze when the numbers, order or surface story change. The remedy is not simply “try harder”; it is to test for the level of knowledge the task actually requires.
...
<img src="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-2-dark.svg" | relative_url }}" alt="Fluency Trap illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **State the claim plainly.** Reduce the idea to a sentence that could be wrong. Vague impressions cannot be tested.
2. **Recall without looking.** Write the idea, steps or argument from memory before rereading.
3. **Explain the mechanism.** Use causal language: what leads to what, under which conditions, and why.
4. **Generate an example and a non-example.** The non-example is crucial because it tests boundaries.
5. **Make a prediction.** Say what should happen in a new case before checking.
6. **Compare with feedback.** Mark not only what was wrong, but what kind of gap caused the error.
7. **Return later.** Space the next attempt so that retrieval is possible but not effortless.
...
<img src="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-3-dark.svg" | relative_url }}" alt="Fluency Trap illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_familiarity_trap_82f724-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
