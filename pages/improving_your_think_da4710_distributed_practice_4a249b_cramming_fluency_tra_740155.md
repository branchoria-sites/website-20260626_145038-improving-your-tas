...
show_ads: true
description: Cramming can create fluent recognition in the moment while leaving knowledge unavailable when real problems appear later.
hero_summary: Cramming can create fluent recognition in the moment while leaving knowledge unavailable when real problems appear later.
layout: default
permalink: /cramming-trap/
sidebar_expanded_urls:
- /improving-your-think/
- /spacing/
nav_short_title: Cramming trap
title: Why cramming feels better than it works
title_full: Why cramming feels better than it works
display_title_short: Cramming trap
display_title: Cramming trap
heading_title: Why cramming feels better than it works
page_heading_title: Why cramming feels better than it works
source_count: 14
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why review should start with recall
header:
  og_image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-1-social.jpg
  preview_image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-1.webp
image: /assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-1-social.jpg
---
...
Every piece of information is surrounded by the same environment, the same notebook, the same sequence of examples and the same uninterrupted train of thought. Because all of these cues remain active, [retrieval]({{ 'retrieval/' | relative_url }}) during the session is unusually easy.
...
<img src="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-2-dark.svg" | relative_url }}" alt="Cramming trap illustration 2" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How spacing exposes fragile understanding

[Distributed practice]({{ 'spacing/' | relative_url }}) deliberately interrupts the comfortable conditions that make cramming feel successful.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/fGP3yK-Cj7Y" title="Spaced Practice vs Cramming | Which Actually Works?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=fGP3yK-Cj7Y" target="_blank" rel="noopener noreferrer">Spaced Practice vs Cramming | Which Actually Works?</a></p><p class="youtube-embed-meta">Channel: Dr. Yu-Ling Lee</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=fGP3yK-Cj7Y" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=fGP3yK-Cj7Y">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-3-dark.svg" | relative_url }}" alt="Cramming trap illustration 3" data-theme-src-dark="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/improving_your_think_da4710_distributed_practice_4a249b_cramming_fluency_tra_740155-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
Cramming can temporarily support performance when the [assessment]({{ 'assessment/' | relative_url }}) closely follows the study session. It is far less reliable when knowledge must be applied after days or weeks, transferred to new problems or combined with information learned elsewhere.
